  ...
  return (
    <div onClick={()=>router.push(`/blog/${data._id}`)} className='mb-4 flex justify-between'>
      <div>
        ...
        <p style={{fontSize:'30px'}} className='first-letter:uppercase mt-2 font-Satoshi text-3xl font-semibold mb-2 cursor-pointer'>{ data.title || 'The Future of Web Development: Trends to Watch in 2025'}</p>
